...
func (c *IdoV1alpha1Client) KPIProfiles(namespace string) KPIProfileInterface {
	return newKPIProfiles(c, namespace)
}

// NewForConfig creates a new IdoV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new IdoV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*IdoV1alpha1Client, error) {
	...
	return &IdoV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new IdoV1alpha1Client for the given config and
...
func New(c rest.Interface) *IdoV1alpha1Client {
	return &IdoV1alpha1Client{c}
}
